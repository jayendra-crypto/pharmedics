...
export const BLOG_DETAILS_BY_ID_REQUEST         = "BLOG_DETAILS_BY_ID_REQUEST";
export const BLOG_DETAILS_BY_ID_SUCCESS         = "BLOG_DETAILS_BY_ID_SUCCESS";
export const BLOG_DETAILS_BY_ID_FAIL            = "BLOG_DETAILS_BY_ID_FAIL";
